...
Type /register to Continue
        ...
        if any(command in message.text for command in gate_active):
            resp = "<b>The Gate Is Not Available For The Use Right Now Bruh ❌</b>"
            await message.reply_text(resp, reply_to_message_id=message.id)
            return False, False, False
...
Message: Only Premium Users are Allowed to use bot in Personal . Although You Can Use Bot Free Here https://t.me/+xDrR-dRWaJ1jNWY1
...
Message: Only Chats Approved By @lord_hanumant_bot Can Only Use Me . To Get Approve Your Chat Follow The Steps .
