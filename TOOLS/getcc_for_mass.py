...
Message: You Can Check 15 CCs at a Time. Buy Plan to Increase Your Limit.

Type /buy For Paid Plan
</b>"""
            return False, resp
        if (role == "ELITE" or role == "LIFETIME") and len(ccs) > 25:            
            resp = f"""<b>
Limit Reached ⚠️

Message: You Can Check 25 CCs at a Time. If You Want To Increase limit Then Buy The Paid Plan  .
