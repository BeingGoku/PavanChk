...
Message: User session has expired. Please contact admin to re-authenticate the scrapper.

The session files need to be deleted and re-authenticated.
</b>"""
...
Message: Failed to start user client: {str(e)}
...
Message: Your Can Scrape 10000 SK at a Time .
