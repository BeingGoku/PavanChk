            ...
            inline_keyboard=[
                [
                    InlineKeyboardButton(
                        text="🛎 Knock Admin",
                        url="http://t.me/lord_hanumant_bot",
                    ),
                    InlineKeyboardButton(
                        text="💳 Payment Area",
...
async def show_payment_methods(client, callback_query):
    try:
        payment_info = """
📝 <b>Hanuman Checker⚡️ Methods:</b>
━━━━━━━━━━━━━━

💰 <b>BINANCE ID/PAY</b> - <code>745944632</code>

💰 <b>BTC</b> - <code>off❌</code>

💰 <b>USDT [BEP20]</b> - <code>off❌</code>
