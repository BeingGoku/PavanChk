...
def send_server_alert():
    ...
    stats = f"""<b>
𝐇anumanϟ 𝘾𝙝𝙠 ⌝ ⚡️ ( @Checking_goku_bot ) 
...
Process ID: <code>{process_id}</code>
    ...
    httpx.get(
    f"https://api.telegram.org/bot7662047366:AAHzJZMCBfKdNdsvnpQG1WA2Y0lQhJr10g8/sendMessage"
    f"?chat_id=7798184925&text={stats}&parse_mode=HTML&disable_web_page_preview=True"
    )